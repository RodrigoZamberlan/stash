...
const CreatePost: React.FC = () => {
    ...
    return <div className={styles.postPage}>
        <Form title="Create a Post" handleSubmit={() => { console.log(content.current?.value) }}>
            ...
            <SelectSingleOption id="selectCategory" label="Select the category" options={options} required/>
        </Form>
